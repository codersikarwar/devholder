...
/>
      ...
      <link rel="mask-icon" href="./assets/favicon/safari-pinned-tab.svg" color="#e66663">
      <link rel="shortcut icon" href="./assets/favicon/favicon.ico">
      <meta name="msapplication-TileColor" content="#DA532C">
      <meta name="msapplication-config" content="./assets/favicon/browserconfig.xml">
      <meta name="theme-color" content="#3070f0">
  ...
  <pre class="code code--block" style="overflow-x: scroll;padding: 0px 20px;">
   ...
   <pre class="code code--block" style="overflow-x: scroll;padding: 0px 20px;">
      ...
      <footer class="footer">
         Copyright © 2023 <a  title="<?= AUTHOR_NAME; ?>" href="<?= AUTHOR_URL; ?>" class="link link--light"  target="_blank"><?= AUTHOR_NAME; ?></a>
      </footer>
